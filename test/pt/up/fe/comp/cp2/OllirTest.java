...
public class OllirTest {
    ...
    @Test
    public void argsComplex() {
        var result = getOllirResult("extra/argsComplex.jmm");

        var output = result.getOllirCode();
    ...
    @Test
    public void argsConds() {
        var result = getOllirResult("extra/argsConds.jmm");

        var method = CpUtils.getMethod(result, "foo");

        // Should check if there is no errors
