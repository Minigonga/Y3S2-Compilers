...
public class JasminTest {
    ...
    @Test
    public void _section1_SuperClass_Declaration() {
        testOllirToJasmin("pt/up/fe/comp/cp3/jasmin/basic/_SuperClass.ollir");
    }

    @Test
    public void _section2_LessThan_And_Combination1() {
        CpUtils.runJasmin(getJasminResult("arithmetic/_LessThanAndCombination1.ollir"), "Result: 0");
    }

    @Test
    public void _section2_LessThan_And_Combination2() {
        CpUtils.runJasmin(getJasminResult("arithmetic/_LessThanAndCombination2.ollir"), "Result: 1");
    }

    @Test
    public void _section2_LessThan_And_Combination3() {
        CpUtils.runJasmin(getJasminResult("arithmetic/_LessThanAndCombination3.ollir"), "Result: 1");
    }

    @Test
    public void _section2_LessThan_Zero() {
        CpUtils.runJasmin(getJasminResult("arithmetic/_LessThanZero.ollir"), "Result: 0");
    }

    @Test
    public void _section2_Zero_LessThan() {
        CpUtils.runJasmin(getJasminResult("arithmetic/_ZeroLessThan.ollir"), "Result: 1");
    }


    @Test
    public void _section3_If_ElseIf_Else() {
        CpUtils.runJasmin(getJasminResult("control_flow/_IfElseIfElseStat.ollir"), "Result: 5");
    }

    @Test
    public void _section7_IntField() {
        CpUtils.runJasmin(getJasminResult("fields/IntField.ollir"), "Result: 1");
    }
    @Test
    public void _section7_BooleanField() {
        CpUtils.runJasmin(getJasminResult("fields/BooleanField.ollir"), "Result: 0");
    }
    @Test
    public void _section7_ArrayField() {
        CpUtils.runJasmin(getJasminResult("fields/ArrayField.ollir"), "Result: 1");
    }

    @Test
    public void _section7_ClassField() {
        testOllirToJasmin("pt/up/fe/comp/cp3/jasmin/fields/ClassField.ollir");
    }

    @Test
    public void _section7_ClassFieldItself() {
        CpUtils.runJasmin(getJasminResult("fields/ClassFieldItself.ollir"), "Result: 1");
    }

    @Test
    public void _extra_Imported_Method_Call_In_Argument() {
        testOllirToJasmin("pt/up/fe/comp/cp3/extra/_ImportedMethodCallInArgument.ollir");
    }
